...
- Name: responsive.spec.ts >> Responsive FR pages >> /fr/best/books/ >> mobile contains FR text
- Location: tests/responsive.spec.ts:21:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/fr/best/books/
Call log:
  - navigating to "http://localhost:4321/fr/best/books/", waiting until "load"
