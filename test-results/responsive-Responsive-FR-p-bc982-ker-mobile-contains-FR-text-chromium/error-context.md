...
- Name: responsive.spec.ts >> Responsive FR pages >> /fr/tools/cold-shower-tracker/ >> mobile contains FR text
- Location: tests/responsive.spec.ts:21:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4321/fr/tools/cold-shower-tracker/
Call log:
  - navigating to "http://localhost:4321/fr/tools/cold-shower-tracker/", waiting until "load"
