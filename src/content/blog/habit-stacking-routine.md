...
faq:
  ...
  - q: "What are good habit stacking examples for mornings?"
    a: "After waking up → drink a glass of water. After brushing teeth → 2-minute stretch. After coffee → write 3 priorities for the day. After getting dressed → 10 push-ups. Each anchor triggers the next action automatically."
  - q: "Why does habit stacking work better than setting reminders?"
    a: "Because it leverages existing neural pathways. Your brain already runs the anchor habit on autopilot. By chaining a new action to it, you skip the decision-making step that causes procrastination and willpower fatigue."
faqFr:
  - q: "Qu'est-ce que l'empilement d'habitudes ?"
    a: "L'empilement d'habitudes est une technique où vous attachez une nouvelle habitude à une existante. Formule : « Après [HABITUDE ACTUELLE], je vais [NOUVELLE HABITUDE] ». Popularisé par James Clear dans Atomic Habits."
  - q: "Quels sont de bons exemples d'empilement matinal ?"
    a: "Après le réveil → boire un verre d'eau. Après le brossage de dents → 2 minutes d'étirement. Après le café → écrire 3 priorités. Après s'être habillé → 10 pompes."
  - q: "Pourquoi l'empilement fonctionne mieux que les rappels ?"
...
<div data-i18n-html="article_habit-stacking-routine_p5"><h2>The Formula</h2></div>
...
<div data-i18n-html="article_habit-stacking-routine_p9"><h2>Why Habit Stacking Works</h2></div>

<div data-i18n-html="article_habit-stacking-routine_p10">Habit stacking leverages the brain's existing neural pathways. When you perform a habit, the neural pathway fires. If you attach a new behavior to that firing pathway, the new behavior piggybacks on the existing one.</div>

<div data-i18n-html="article_habit-stacking-routine_p11">This is why the order matters. "After I brush my teeth, I will meditate" works. "After I meditate, I will brush my teeth" does not — because you do not meditate every day yet.</div>
...
<div data-i18n-html="article_habit-stacking-routine_p19"><h3>1. Start With One Stack</h3>
...
<div data-i18n-html="article_habit-stacking-routine_p22"><h3>4. Never Break the Chain</h3>
The power of habit stacking is in the repetition. If you miss one link, the chain breaks and you have to rebuild. Protect the chain at all costs.</div>
...
<div data-i18n-html="article_habit-stacking-routine_p28">One habit stacked on another creates a routine. A routine repeated for 30 days becomes automatic. Once automatic, it becomes part of your identity.</div>

<div data-i18n-html="article_habit-stacking-routine_p29">You do not have to think about your morning routine. You just do it. That is the power of habit stacking — it transforms conscious effort into unconscious behavior.</div>
