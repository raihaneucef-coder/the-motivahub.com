...
export const podcasts: Podcast[] = [
  ...
  },
  {
    ...
    description: "Andrew Huberman — science of dopamine and drive. Evidence-based strategies for focus and sustained motivation.",
  ...
  },
  {
    ...
    description: "Steven Bartlett x David Goggins — discipline over motivation, no excuses.",
  ...
  },
  {
    ...
    description: "Jay Shetty — protecting attention in a noisy world.",
  ...
  },
  {
    ...
    description: "Lewis Howes — interviews with top performers on mindset and grit.",
  ...
  },
  {
    ...
    description: "Mel Robbins — motivation to take action before fear wins.",
  ...
  },
  {
    ...
    description: "Jocko Willink — US Navy SEAL on discipline as freedom.",
